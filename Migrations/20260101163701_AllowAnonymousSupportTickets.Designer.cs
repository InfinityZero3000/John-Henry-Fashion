...
namespace JohnHenryFashionWeb.Migrations
{
    ...
    [Migration("20260101163701_AllowAnonymousSupportTickets")]
    partial class AllowAnonymousSupportTickets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JohnHenryFashionWeb.Models.Order", b =>
                {
                    ...
                    b.Property<bool>("IsRevenueCalculated")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsSellerConfirmed")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsUserConfirmedDelivery")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("RevenueCalculatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("SellerConfirmedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("SellerConfirmedBy")
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime?>("UserConfirmedDeliveryAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("JohnHenryFashionWeb.Models.OrderRevenue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JohnHenryFashionWeb.Models.UserPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JohnHenryFashionWeb.Models.OrderRevenue", b =>
                {
                    b.HasOne("JohnHenryFashionWeb.Models.Order", "Order")
                        .WithOne("Revenue")
                        .HasForeignKey("JohnHenryFashionWeb.Models.OrderRevenue", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
